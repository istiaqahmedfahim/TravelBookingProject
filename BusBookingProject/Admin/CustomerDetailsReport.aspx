<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CustomerDetailsReport.aspx.cs" Inherits="BusBookingProject.Admin.CustomerDetailsReport" %>
        ...
        <asp:GridView ID="gdBusDetails" runat="server" EmptyDataText="No Record Found...." AutoGenerateColumns="False" AllowPaging="true" PageSize="20" CssClass="table table-hover table-bordered"
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="Customer ID">
                         ...
                         <asp:TemplateField HeaderText="Number of seat">
                           <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlinkUpdate" runat="server" >Update Details</asp:HyperLink>
                                 <asp:HyperLink ID="hlinkAddSchedule" runat="server" >Add Customer Schedule</asp:HyperLink>
